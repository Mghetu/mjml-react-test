...
<mj-section padding-top="10px" padding-bottom="0px" background-color="#ffffff" padding-left="25px" padding-right="25px">
      ...
      <mj-section padding-top="0px" padding-bottom="0px" background-color="#ffffff">
        <mj-column vertical-align="middle" padding-top="10px" padding-bottom="10px" padding-right="0px" padding-left="0px" width="100%">
          <mj-spacer height="10px" container-background-color="#f5f5f5">
          </mj-spacer>
        </mj-column>
      </mj-section>`
  );
...
<mj-section padding-top="10px" padding-bottom="0px" background-color="#ffffff" padding-left="25px" padding-right="25px">
        ...
        <mj-group>
          <mj-column padding-top="10px" padding-right="0px" padding-bottom="0px" padding-left="0px" width="30%">
            <mj-button border-radius="20px 20px 20px 20px" font-size="12px" font-weight="700" color="#54728d" padding-top="0px" padding-bottom="0px" padding-right="10px" padding-left="0px" align="left" font-family="Aptos, Calibri, sans-serif" width="100%" background-color="#d8fef3" border="0 none black">Read the article
            </mj-button>
          </mj-column>
        </mj-group>
      </mj-section>
