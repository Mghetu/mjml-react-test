...
const initialTemplate = [
  '<mjml>',
  '  <mj-body background-color="#F3F6F9">', // fallback; wrapper below does the real Outlook-safe paint',
  '',
  '    <!-- Outlook-safe page background: wrapper renders as a 100% table with bgcolor -->',
  '    <mj-wrapper full-width="full-width" background-color="#F3F6F9" padding="24px 0">',
  '',
  '      <!-- Header / announcement strip (600px wide, centered) -->',
  ...
  '            This starter uses a full-width <code>mj-wrapper</code> to paint the page background so Outlook shows it.',
  '            Content stays in 600px-centered sections. Duplicate sections or add columns as needed.',
  '          </mj-text>',
  ...
  '      </mj-section>',
  '',
  '      <!-- Multi-column row (edit freely) -->',
  '      <mj-section background-color="#FFFFFF" padding="16px 24px" border-radius="8px">',
  '        <mj-column>',
  '          <mj-text font-family="Aptos, Calibri, sans-serif" font-size="16px" font-weight="600" line-height="1.5" color="#262626" padding="0 0 8px">',
  '            Left column',
  '          </mj-text>',
  '          <mj-text font-family="Aptos, Calibri, sans-serif" font-size="16px" line-height="1.5" color="#262626" padding="0">',
  ...
  '          </mj-text>',
  '          <mj-text font-family="Aptos, Calibri, sans-serif" font-size="16px" line-height="1.5" color="#262626" padding="0">',
  '            Duplicate this section for more rows.',
  '          </mj-text>',
  '        </mj-column>',
  '      </mj-section>',
  '',
  '      <!-- Footer -->',
  '      <mj-section background-color="#FAFBFC" padding="16px 24px" border-radius="8px">',
  '        <mj-column>',
